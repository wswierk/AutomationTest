...
public class BasketPage {
    ...
    private WebElement waitForPage;

    @FindBy(className = "inventory_item_name")
    private List<WebElement> basketItemName;
    ...
    public String getBasketItemName() {
        return basketItemName.get(0).getText();
    }
    ...
    public int isItemNameDisplayed() {
        return basketItemName.size();
    }
